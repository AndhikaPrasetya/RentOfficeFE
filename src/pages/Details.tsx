              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, index) => (
                  <img
                    key={index}
                    src={
                      index < Math.round(office?.rating || 0) // Round the rating to the nearest whole number
                        ? "/assets/images/icons/Star 1.svg" // Full star
                        : "/assets/images/icons/Star 5.svg" // Assuming Star 5.svg is your empty star
                    }
                    className="w-5 h-5"
                    alt="star"
                  />
        ...
        <div className="w-[392px] flex flex-col shrink-0 gap-[30px]">
          <div className="flex flex-col rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
            ...
            <div className="flex flex-col gap-5">
              {office?.benefits && office.benefits.length > 0 ? (
